  ...
  return (
    <section id="tutores" className="bg-amber-50 py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-6" tabIndex={2}>Conheça nossos tutores</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-bold mb-2" tabIndex={2}>Giovana Mattos</h3>
          ...
          {/* Tutor 2 */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-bold mb-2" tabIndex={2}>Augusto Ladeira</h3>
            <p className="text-gray-700 mb-4" tabIndex={2}>
          ...
          {/* Tutor 3 */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-xl font-bold mb-2" tabIndex={2}>Alberto Souza</h3>
            <p className="text-gray-700 mb-4" tabIndex={2}>
