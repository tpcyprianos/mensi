  ...
  return (
    <section id="recomendacoes" className="bg-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-6" tabIndex={2}>Os estudantes recomendam</h2>

        <p className="text-center text-gray-700 max-w-3xl mx-auto mb-12" tabIndex={2}>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="border border-cyan-400 rounded-lg p-6 relative">
            <div className="text-gray-700 mb-4" tabIndex={2}>
            ...
            <div className="font-semibold text-right" tabIndex={2}>— Lara, 18 anos</div>
          </div>
          ...
          <div className="border border-cyan-400 rounded-lg p-6 relative">
            ...
            <div className="font-semibold text-right" tabIndex={2}>— Alex, 16 anos</div>
          </div>
          ...
          <div className="border border-cyan-400 rounded-lg p-6 relative">
            ...
            <div className="font-semibold text-right" tabIndex={2}>— Adriana, 20 anos</div>
          </div>
        </div>
      </div>
    </section>
