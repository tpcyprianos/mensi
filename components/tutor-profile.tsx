          ...
          <div className="lg:w-2/3">
            <div className="flex flex-col md:flex-row items-start gap-6 mb-8">
              ...
              <div className="flex-grow">
                ...
                {/* Bio (se disponível) */}
                {tutor.bio && <p className="text-gray-700 leading-relaxed" tabIndex={2}>{tutor.bio}</p>}
              </div>
            </div>
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2" tabIndex={2}>
                <Calendar size={20} />
              ...
              {selectedDate && (
                <div className="bg-white rounded-lg p-6 shadow-sm">
                  <h3 className="text-lg font-semibold text-gray-800 mb-4" tabIndex={2}>
                  ...
                  {selectedTime && (
                    <div className="mt-4 p-4 bg-green-100 border border-green-300 rounded-lg">
                      <p className="text-green-800 font-medium" tabIndex={2}>
                        ✓ Horário selecionado: {selectedTime} do dia {selectedDate}
                      </p>
                      <p className="text-green-700 text-sm mt-1" tabIndex={2}>
